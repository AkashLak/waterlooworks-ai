...
Analyze whether this job, despite its title, is primarily a QA, test automation, build/release engineering, or operations role in disguise as a software development role.
...
{
  "isDisguised": <boolean>,
  "actualRole": "<the real role type, e.g. 'QA / Test Automation Engineer', or null if not disguised>",
  "redFlags": [<quoted phrases from the description that indicate this>]
}
...
A student has a question about a job posting. Answer it clearly, honestly, and concisely. Focus on what is practically useful for a co-op student deciding whether to apply.
...
const WWAi = (() => {
    ...
    const ENDPOINT_BASE  = 'https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key=';
