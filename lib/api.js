...
const WWApi = (() => {
     ...
     */
    async function getDreamFit(jobId, resumeText) {
        return _request('POST', '/api/dream-fit', { jobId, resumeText });
    }
     ...
     * @returns {Promise<Object>}
     */
    async function syncActiveJobs(rows) {
        return _request('POST', '/api/jobs/sync-active', { jobs: rows });
    }
