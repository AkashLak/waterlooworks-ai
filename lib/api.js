...
const WWApi = (() => {
     ...
     */
    async function askQuestion(jobId, question, resumeText, apiKey) {
        return _request('POST', `/api/jobs/${encodeURIComponent(jobId)}/ask`, { question, resumeText, ...(apiKey ? { apiKey } : {}) });
    }
