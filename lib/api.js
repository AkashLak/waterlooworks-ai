...
const WWApi = (() => {
     ...
     */
    async function getFitScore(jobId, resumeText, resumeHash, quotaHash, apiKey) {
        return _request('POST', '/api/fit-score', { jobId, resumeText, resumeHash, quotaHash, ...(apiKey ? { apiKey } : {}) });
    }
     ...
     */
    async function getDreamFit(jobId, resumeText, dreamCriteria, resumeHash, quotaHash, apiKey) {
     ...
     */
    async function searchJobs(resumeText, criteria, resumeHash, quotaHash, apiKey) {
        return _request('POST', '/api/jobs/search', { resumeText, resumeHash, quotaHash, ...criteria, ...(apiKey ? { apiKey } : {}) });
    }
     ...
     */
    async function askQuestion(jobId, question, resumeText, apiKey, resumeHash, quotaHash) {
        return _request('POST', `/api/jobs/${encodeURIComponent(jobId)}/ask`, { question, resumeText, resumeHash, quotaHash, ...(apiKey ? { apiKey } : {}) });
    }
    ...
    async function getQuotaStatus(quotaHash) {
        return _request('GET', `/api/quota?quotaHash=${encodeURIComponent(quotaHash)}`);
    }
